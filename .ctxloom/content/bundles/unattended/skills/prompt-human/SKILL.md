---
name: prompt-human
description: Find everything blocked on a human decision, then put each one to them as an interactive question carrying far more context than usual — because they know the project but are running several threads at once and have no idea which one this is. Use when asked "what's pending", "anything for me?", "what needs deciding", "what's blocked on me", "ask me", "check with me" — and before ending a work session, cutting a release, or handing off.
---
